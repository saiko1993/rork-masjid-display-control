    ...
    var body: some View {
        Canvas { context, canvasSize in
            ...
            for i in 0..<starCount {
                ...
                let twinkle = sin(phase * 0.4 + seed * 1.2) * 0.5 + 0.5
    ...
    var body: some View {
        Canvas { context, canvasSize in
            ...
            for i in 0..<count {
                ...
                let floatY = sin(phase * 0.12 + seed) * 6
                let floatX = cos(phase * 0.08 + seed * 0.5) * 3
                let particleSize = (sin(seed) * 0.5 + 0.5) * 5 + 3
                let opacity = sin(phase * 0.15 + seed * 1.1) * 0.25 + 0.35
